...
public class LoginUser extends JPanel {
	private static final long serialVersionUID = 1L;
	public JLabel titleLabel;
	public JLabel studentJLabel;
	...
	/**
	 * loginUser() Place the components onto the user login panel.
	 **/
	public LoginUser() {
		...
		titleLabel = new JLabel("Login with a student account...");
		gbc.gridx = 0;
		gbc.gridy = 0;
		gbc.gridwidth = 2;
		gbc.weightx = 1.0;
		...
		studentJLabel = new JLabel("Student No.: ", idIcon, JLabel.LEFT);
		studentJLabel.setIconTextGap(8);
		gbc.gridx = 0; 
		gbc.gridy = 1;
		gbc.gridwidth = 1;
		gbc.weightx = 0;
